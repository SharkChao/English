...
public class TikuActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void startTikuActivity(Context context, String tag, String title) {
        context.startActivity(new Intent(context, TikuActivity.class));
        TikuActivity.tag = tag;
        TikuActivity.title = title;
    }
